...
public class CourseController {
    ...
    @GetMapping("/getById")
    public String getById(@RequestParam int id, Map<String, Course> model) {
    ...
    public String loadUpdateForm(@RequestParam int id, Map<String, Course> model, Map<String, List<Lecturer>> lecturers, ModelMap modelMap) {
        modelMap.addAttribute("course", new Course());
    ...
    public String loadDeleteForm(@RequestParam int id, Map<String, Course> model, ModelMap modelMap) {
        modelMap.addAttribute("course", new Course());
